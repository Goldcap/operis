...
});Ember.TEMPLATES['components/pagination-page'] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("<a ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "pageClicked", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data})));
  data.buffer.push(">");
...
function program4(depth0,data) {
  ...
  data.buffer.push(">\n        <a ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "goToPreviousPage", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data})));
  data.buffer.push(">&laquo;</a>\n      </li>\n      ");
  stack1 = helpers['if'].call(depth0, "showBeforeEllipsis", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(5, program5, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n      ");
  stack1 = helpers.each.call(depth0, "pageNumber", "in", "visiblePages", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(7, program7, data),contexts:[depth0,depth0,depth0],types:["ID","ID","ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n      ");
  stack1 = helpers['if'].call(depth0, "showAfterEllipsis", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(9, program9, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n      <li ");
  data.buffer.push(escapeExpression(helpers['bind-attr'].call(depth0, {hash:{
  ...
  data.buffer.push(">\n        <a ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "goToNextPage", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data})));
  data.buffer.push(">\n          &raquo;\n        </a>\n    </ul>\n");
  return buffer;
  }
function program5(depth0,data) {
  ...
  data.buffer.push("\n        ");
  data.buffer.push(escapeExpression((helper = helpers['pagination-page'] || (depth0 && depth0['pagination-page']),options={hash:{
    'page': (1),
    'currentPage': ("page")
  },hashTypes:{'page': "INTEGER",'currentPage': "ID"},hashContexts:{'page': depth0,'currentPage': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "pagination-page", options))));
...
function program7(depth0,data) {
  ...
  data.buffer.push(escapeExpression((helper = helpers['pagination-page'] || (depth0 && depth0['pagination-page']),options={hash:{
    'page': ("pageNumber"),
    'currentPage': ("page")
  },hashTypes:{'page': "ID",'currentPage': "ID"},hashContexts:{'page': depth0,'currentPage': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "pagination-page", options))));
  data.buffer.push("\n      ");
  return buffer;
  }
...
function program9(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n</table>\n\nTotal Results: ");
  stack1 = helpers._triageMustache.call(depth0, "controller.count", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n");
  stack1 = helpers['if'].call(depth0, "showPagination", {hash:{},hashTypes:{},hashContexts:{},inverse:self.noop,fn:self.program(4, program4, data),contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  return buffer;
